...
import '../controllers/chats_cubit.dart';

class ChatSearchPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      chatsCubit.state.userChats.isNotEmpty
          ? searchCubit.startListeningChatUpdates(authCubit.user!)
          : null;
      return null;
    }, ['key']);
